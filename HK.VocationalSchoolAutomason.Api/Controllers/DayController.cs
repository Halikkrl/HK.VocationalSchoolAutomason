...
namespace HK.VocationalSchoolAutomason.Api.Controllers
{
    ...
    public class DayController : ControllerBase
    {
        ...
        public DayController(IDay service)
        {
            _service = service;
        }
        ...
        {
            var Response = await _service.GetById<DayListDto>(id);
            return Ok(Response);
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromQuery] DayCreateDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] DayUpdateDto dto)
        {
