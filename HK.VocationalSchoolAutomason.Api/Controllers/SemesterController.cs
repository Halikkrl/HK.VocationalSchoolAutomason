...
namespace HK.VocationalSchoolAutomason.Api.Controllers
{
    ...
    {
        private readonly ISemester _service;
        ...
        {
            var Response = await _service.GetById<SemesterListDto>(id);
            return Ok(Response);
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromQuery] SemesterCreateDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] SemesterUpdateDto dto)
        {
