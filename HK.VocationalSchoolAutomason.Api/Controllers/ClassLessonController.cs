...
namespace HK.VocationalSchoolAutomason.Api.Controllers
{
    ...
    {
        private readonly IClassLesson _service;

        public ClassLessonController(IClassLesson service)
        {
            _service = service;
        }
        ...
        {
            var Response = await _service.GetById<ClassLessonListDto>(id);
            return Ok(Response);
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromQuery] ClassLessonCreateDto dto)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ClassLessonUpdateDto dto)
        {
