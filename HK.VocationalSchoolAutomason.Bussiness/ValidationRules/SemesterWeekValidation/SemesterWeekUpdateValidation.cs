...
{
    public class SemesterWeekUpdateValidation : AbstractValidator<SemesterWeekUpdateDto>
    {
        public SemesterWeekUpdateValidation()
        {
            RuleFor(x => x.Id)
                .NotEmpty().WithMessage("Dönem Hafta ID boş olamaz.")
                .GreaterThan(0).WithMessage("Dönem Hafta ID geçerli bir değer olmalıdır.");
