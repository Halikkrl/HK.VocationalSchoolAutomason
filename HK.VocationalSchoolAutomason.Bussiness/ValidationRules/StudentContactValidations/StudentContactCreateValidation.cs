...
namespace HK.VocationalSchoolAutomason.Bussiness.ValidationRules.StudentContactValidations
{
    public class StudentContactCreateValidation : AbstractValidator<StudentContactCreateDto>
    {
        public StudentContactCreateValidation()
        {
            ...
            RuleFor(contact => contact.PhoneNumber)
                ...
                .Matches(@"^\d{10}$").WithMessage("Başında 0 olmadan geçerli bir telefon numarası giriniz.");
