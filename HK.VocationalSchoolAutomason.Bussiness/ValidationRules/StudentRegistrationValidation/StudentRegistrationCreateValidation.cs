...
{
    public class StudentRegistrationCreateValidation : AbstractValidator<StudentRegistrationCreateDto>
    {
        public StudentRegistrationCreateValidation()
        {
            ...
            RuleFor(dto => dto.StudentId)
                ...
                .WithMessage("Geçerli bir öğrenci bilgisi gereklidir.");
        }
    }
}
