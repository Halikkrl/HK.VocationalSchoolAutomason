...
{
    public class ScheduleInformationUpdateValidation : AbstractValidator<ScheduleInformationUpdateDto>
    {
        public ScheduleInformationUpdateValidation()
        {
            ...
            RuleFor(dto => dto.Id).GreaterThan(0).WithMessage("ID pozitif bir değer olmalıdır.");
